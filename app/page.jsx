...
export const metadata = {
  title: 'Bargain Bay — Discount Appliances Pickering & Scarborough | Tested & Working',
  description:
    'Name-brand appliances. Liquidation prices. Every unit tested & working with a one-year warranty — pickup, delivery & freight serving Pickering, Scarborough and the GTA.',
  ...
  return (
    <div>
      ...
      <div className="trust-strip">
        ...
        <div className="item"><span className="ico">⇄</span><div><b>Pickup, delivery &amp; freight</b><span>Free warehouse pickup, flat-fee local delivery, freight for the big stuff — Durham Region / GTA.</span></div></div>
      </div>
      ...
      <div className="panel" style={{ marginTop: 32 }}>
        ...
        <p style={{ fontSize: 14.5, margin: '8px 0' }}>
          ...
          serving Pickering, Scarborough and the GTA.
        </p>
        <p style={{ fontSize: 14.5, margin: '8px 0' }}>
          ...
          pay on pickup. Get it home — free pickup from our Pickering warehouse, flat-fee local
