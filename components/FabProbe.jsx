'use client';
// TEMPORARY DIAGNOSTIC — reports what this device's browser thinks the chat
// FAB's box/visibility are. Renders a yellow readout bar at the top of the
// page. Remove once the mobile chat-bubble issue is diagnosed.
  ...
  useEffect(() => {
    const run = () => {
      ...
      const lines = [
        ...
        `belowFold=${r.top > innerHeight ? 'YES' : 'no'}  hitTest=${hit}`,
