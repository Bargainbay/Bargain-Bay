...
// Download the tracker .xlsx bytes and return the chosen tab as a CSV string.
// No Drive file is created (download needs only Viewer access).
async function trackerTabCsv() {
