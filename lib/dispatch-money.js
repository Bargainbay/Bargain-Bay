...
// holds a 191-hour shift, an 83-hour one, and five over 16h — all of them a
// driver who forgot the Done tap, not a driver who was working. Charging
// Ruban's $25/h against 191 hours invents $4,775 of cost, and the owner would
// be reading it as fact.
//
...
const MAX_PLAUSIBLE_SHIFT_HOURS = 14;
const SHIFT_PRICEABLE = `s.ended_at IS NOT NULL
  AND s.ended_at > s.started_at
  AND EXTRACT(EPOCH FROM (s.ended_at - s.started_at)) <= ${MAX_PLAUSIBLE_SHIFT_HOURS} * 3600`;
