...
// Fulfilment fields (deliveryMethod/address/city/postal/phone) are captured here
// and flow into the order created when the invoice is marked paid.
export async function createAndSendInvoice({ name, email, items, addHst, daysUntilDue = 14, memo, deliveryMethod, address, city, postal, phone }) {
