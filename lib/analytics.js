...
// Inventory financials from the synced catalog (in-stock units). `cost` is the
// tracker's Total Cost; populated by the sheet sync. Synchronous (no DB).
export function inventoryFinancials() {
