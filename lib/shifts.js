  ...
  if (shift.driving !== false && van) {
    for (const km of [kmIn, kmOut]) {
      ...
      if (km != null && (!unchanged || van !== shift.vehicle_id)) {
        ...
        await assertOdometer(van, km, { vehicleName: vName });
      }
    }
  }
